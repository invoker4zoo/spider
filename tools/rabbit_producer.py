...
if __name__ == "__main__":
    import json
    message1 = json.dumps({"companyName": "易极付"})
    connection = AsyProducer(host="localhost", user_name="admin", password="admin123")
    for i in range(201):
    ...
    for i in range(5):
        ...
        connection = AsyProducer(host="localhost", user_name="admin", password="1qaz2wsx")
        # 基本用法
